package com.etop.baseProject.commons.shiro.support;
...
public class Permission {
    ...
    private static final Logger logger = (Logger) Logger.getLogger(String.valueOf(Permission.class));
    ...
    public Object getPrincipalProperty(String property){
        ...
        if(subject != null){
            ...
            try {
                ...
                logger.info("Property [{}] not found in principal of type [{}]"+property+
                        principal.getClass().getName());
            } catch (Exception e) {
                logger.info("Error reading property [{}] from principal of type [{}]"+ property+
                        principal.getClass().getName());
            }
        }
        return null;
